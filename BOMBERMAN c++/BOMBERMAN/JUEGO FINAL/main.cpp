...
void Imprimir_vida(int energy_BB ,int energy_BM){
	char Barra[2][41]={
			...
			if(menu_dos.opcion == "A" || menu_dos.opcion == "a"){
				...
				if (submenu_uno.opcion == "X" || submenu_uno.opcion == "x") {
					...
					while(facil==true){						
						...
						Imprimir(Mapa);
						Imprimir_vida(BB.energy,BM.energy);
			    ...
			    if(menu_cinco.opcion == "A" || menu_cinco.opcion == "a"){
					...
					{' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '},
							...
							if(murioDS01!=true || DS01.exDS==true)		DS01.BombaDS();      //es una probabilidad de poner una bomba
							if(murioDS02!=true || DS02.exDS==true)		DS02.BombaDS(); 
							if(murioDS03!=true || DS03.exDS==true)		DS03.BombaDS(); 
							if(murioDS04!=true || DS04.exDS==true)		DS04.BombaDS(); 
			    	...
			    	string menu_victoria[7] ={"              ¡VICTORIA!                     ",
										      "                                             ",
										      "    Numero partidas ganadas: "+w+"               ",
										      "    Numero partidas perdidas: "+l+"              ", 
											  "                                             ",   
					 						  "    Presiona a para volver al menu:          ",
					 						  "    Presione b para ver el salon de la fama: "
											  };
					string menu_derrota[7] ={"              GAME OVER                      ",
											 "                                             ",
											 "    Numero partidas ganadas: "+w+"               ",
										     "    Numero partidas perdidas: "+l+"              ", 
										     "                                             ",
			    	...
			    	if(victorias>derrotas){
			    		score_now=100*victorias;
			    		Menu victoria(7,9);
			    		victoria.draw(menu_victoria);
			    		if(victoria.opcion == "A" || victoria.opcion == "a") repetir=true;
						else if (victoria.opcion == "B" || victoria.opcion == "b"){
			    		...
			    		if(derrota.opcion == "A" || derrota.opcion == "a") repetir=true;
						else if (derrota.opcion == "B" || derrota.opcion == "b"){
